        ...
        private async void LoadStopperMachineMonitorView()
        {
            try
            {
                ...
                if (AllTags.Count != 0)
                {
                    ...
                    GoodCount = Convert.ToInt64(await _signalRClient.GetBufferValue("IE-F2-HCA01", "goodProduct"));
                    ...
                    isConnectPLC = Convert.ToInt64(await _signalRClient.GetBufferValue("IE-F2-HCA01", "isConnectPLC"));
                    ...
                    TR1 = new(Convert.ToInt64(await _signalRClient.GetBufferValue("IE-F2-HCA01", "BOTTOM_CAP_REJ_TR1")), Convert.ToInt64(await _signalRClient.GetBufferValue("IE-F2-HCA01", "SILICON_PRESENCE_REJ_TR1")),
                             ...
                             Convert.ToInt64(await _signalRClient.GetBufferValue("IE-F2-HCA01", "LEAK_TEST_CHK_TR1")));
                    ...
                    TR4 = new(Convert.ToInt64(await _signalRClient.GetBufferValue("IE-F2-HCA01", "BOTTOM_CAP_REJ_TR4")), Convert.ToInt64(await _signalRClient.GetBufferValue("IE-F2-HCA01", "SILICON_PRESENCE_REJ_TR4")),
            ...
            if (tag != null)
            {
                if (tag.StationId == "IE-F2-HCA01")  
                {
                    switch (tag.TagId)
                    {
                        ...
                        case "LEAK_TEST_CHK_TR1": TR1.LEAKTESTCHKOK = Convert.ToInt64(tag.TagValue); RejectionChanged(); break;
